...
exports.Notifications  = mongolass.model('Notifications', {
    id:{type: Mongolass.Types.ObjectId},
    articleId:{type:Mongolass.Types.ObjectId},
    commentNickname:{type:'string'},
    is_read:{type:'number'},//default  0  not read
});
exports.Notifications.index({ _id: 1 }).exec();// 通过评论 id 删除一个留言
